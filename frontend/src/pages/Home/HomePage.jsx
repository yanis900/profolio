    ...
    <>
      ...
      <div className="w-screen h-screen flex flex-col justify-center items-center">
        <div className="flex mt-100">
          <div className="w-1/2 h-full border flex items-center justify-center p-20">
            <div className="relative">
              <Safari
                url="shadcn.io"
                className="size-full"
                // imageSrc="https://d3m8mk7e1mf7xn.cloudfront.net/64224402d24ae443b84e744a/1679968753139Fun.png"
              />
            </div>
          </div>
          <div className="w-1/2 h-full flex flex-col items-start justify-center gap-2 p-10">
            <div className="flex">
              <a
              ...
              >
                <svg
                  ...
                  viewBox="0 0 122 37"
                  className="w-32 fill-base-content-secondary/80 hover:fill-base-content md:w-36"
                >
            ...
            <div className="flex flex-col gap-3 items-start">
              <h1 className="text-4xl font-black leading-tight tracking-tight md:text-5xl md:leading-tight lg:text-6xl lg:leading-tight">
                Welcome to Profolio!
              </h1>
              <h3>Start by making your portfolio today</h3>
            </div>
              <Button className='mt-5'>Create a Profile here!</Button>
          </div>
        </div>

        <section className="bg-base-100 p-6 py-16 border">
          <div className="-mx-6 space-y-4 overflow-scroll px-6">
            {/* Row 1 */}
            <div className="-ml-2 flex items-center gap-4">
              <Card className="group rounded-2xl bg-base-300 p-6">
                <CardContent className="flex gap-4 p-0">
                  <span className="md:w-18 md:h-18 flex h-12 w-12 items-center justify-center rounded-full bg-base-100 duration-200 group-hover:-rotate-3">
                    <img
                      alt="damon profile picture"
                      loading="lazy"
                      width="48"
                      height="48"
                      decoding="async"
                      className="md:w-18 md:h-18 h-12 w-12 rounded-full bg-base-100 object-cover"
                      src="https://d3m8mk7e1mf7xn.cloudfront.net/64878179f2c86b18ad5416d0/1686602129097damonchen.png"
                    />
                  </span>
                  <div className="flex-1">
                    ...
                    <span className="badge whitespace-nowrap">8 startups</span>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="flex gap-4 p-0">
                  <span className="md:w-18 md:h-18 flex h-12 w-12 items-center justify-center rounded-full bg-base-100 duration-200 group-hover:-rotate-3">
                    <img
                      ...
                      decoding="async"
                      className="md:w-18 md:h-18 h-12 w-12 rounded-full bg-base-100 object-cover"
                      src="https://d3m8mk7e1mf7xn.cloudfront.net/64224402d24ae443b84e744a/1679968753139Fun.png"
                    />
                  </span>
                  <div className="flex-1">
                    <p className="w-28 truncate font-bold duration-200 group-hover:underline">
                    ...
                    <span className="badge whitespace-nowrap">27 startups</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="group rounded-2xl bg-base-300 p-6">
                <CardContent className="flex gap-4 p-0">
                  <span className="md:w-18 md:h-18 flex h-12 w-12 items-center justify-center rounded-full bg-base-100 duration-200 group-hover:-rotate-3">
                    <img
                      alt="arvid profile picture"
                      loading="lazy"
                      width="48"
                      height="48"
                      decoding="async"
                      className="md:w-18 md:h-18 h-12 w-12 rounded-full bg-base-100 object-cover"
                      src="https://pbs.twimg.com/profile_images/1201525049766883328/QPimCC9z.jpg"
                    />
                  </span>
                  <div className="flex-1">
                    <p className="w-28 truncate font-bold duration-200 group-hover:underline">
                    ...
                    <span className="badge whitespace-nowrap">5 startups</span>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="flex gap-4 p-0">
                  <span className="md:w-18 md:h-18 flex h-12 w-12 items-center justify-center rounded-full bg-base-100 duration-200 group-hover:-rotate-3">
                    <img
                      ...
                      decoding="async"
                      className="md:w-18 md:h-18 h-12 w-12 rounded-full bg-base-100 object-cover"
                      src="https://d3m8mk7e1mf7xn.cloudfront.net/64283e45e3e7f553ef549c41/1686624632931avatar-color-2.webp"
                    />
                  </span>
                  <div className="flex-1">
                    <p className="w-28 truncate font-bold duration-200 group-hover:underline">
                ...
                <CardContent className="flex gap-4 p-0">
                  <span className="md:w-18 md:h-18 flex h-12 w-12 items-center justify-center rounded-full bg-base-100 duration-200 group-hover:-rotate-3">
                    <img
                      ...
                      decoding="async"
                      className="md:w-18 md:h-18 h-12 w-12 rounded-full bg-base-100 object-cover"
                      src="https://pbs.twimg.com/profile_images/1603462822423416832/Rck3-3Ov.png"
                    />
                  </span>
                  <div className="flex-1">
                    <p className="w-28 truncate font-bold duration-200 group-hover:underline">
                      🧞‍♂️Martin Donadieu in Portugal 🇵🇹
                    </p>
                    <span className="badge whitespace-nowrap">8 startups</span>
                  </div>
                </CardContent>
            ...
            {/* TODO: Add remaining rows (Rob Hallam, Alexander Belogubov, Daka, Jamie Nicol, Yuexun, Larsen Cundric, etc.) */}
