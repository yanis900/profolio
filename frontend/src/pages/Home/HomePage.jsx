        ...
        <div className="flex mt-100">
          ...
          <div className="w-1/2 h-full flex flex-col items-start justify-center gap-2 p-10">
            <div className="flex">
              ...
              >
                <svg
                  ...
                  viewBox="0 0 122 37"
                  className="w-32 fill-[#0A2243]/80 hover:fill-base-content md:w-36"
                >
            ...
            <div className="flex flex-col gap-3 items-start">
              <h1 className="text-4xl text-[#0A2243] font-black leading-tight tracking-tight md:text-5xl md:leading-tight lg:text-6xl lg:leading-tight">
                Welcome to ProFolio!
              </h1>
              <h3 className="text-[#0A2243]">Start by making your portfolio today</h3>
            </div>
              <Button className='mt-5 bg-[#0A2243] hover:bg-[#FFD300] hover:text-[#0A2243]' onClick={signUp}>Create a Profile here!</Button>
          </div>
        </div>
              ...
              <Card className="group rounded-2xl bg-base-300 p-6">
                <CardContent className="flex gap-4 p-0">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="badge whitespace-nowrap">8 projects</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="group rounded-2xl bg-base-300 p-6">
                <CardContent className="flex gap-4 p-0">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="badge whitespace-nowrap">27 projects</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="group rounded-2xl bg-base-300 p-6">
                <CardContent className="flex gap-4 p-0">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="badge whitespace-nowrap">5 projects</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="group rounded-2xl bg-base-300 p-6">
                <CardContent className="flex gap-4 p-0">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="badge whitespace-nowrap">7 projects</span>
                  </div>
                </CardContent>
              </Card>
